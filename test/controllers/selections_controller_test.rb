...
class SelectionsControllerTest < ActionController::TestCase
  ...
  test "should create selection" do
    assert_difference('Selection.count') do
      post :create, selection: { album_id: @selection.album_id, photos: @selection.photos, user_id: @selection.user_id }
    end
  ...
  test "should update selection" do
    patch :update, id: @selection, selection: { album_id: @selection.album_id, photos: @selection.photos, user_id: @selection.user_id }
    assert_redirected_to selection_path(assigns(:selection))
  end
